...
for tag in v3.3.3 v3.4.0 v3.4.1 v3.4.2 v3.4.3 v3.5.0 v3.5.1 v3.5.2 v3.5.3 v3.5.4 v3.5.5 v3.5.6 v3.5.7 v3.5.8 v3.5.9 v3.6.0; do
    sha="${TAGS[$tag]}"
...
echo "Done. Latest release should be v3.6.0 under $LOGIN."
